...
namespace IntroduccionAEFCore1.Migrations
{
    ...
    [Migration("20230510195536_IndiceUncoNombre")]
    partial class IndiceUncoNombre
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IntroduccionAEFCore1.Entidad.Actor", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("IntroduccionAEFCore1.Entidad.Comentario", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("IntroduccionAEFCore1.Entidad.Genero", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("IntroduccionAEFCore1.Entidad.Pelicula", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("IntroduccionAEFCore1.Entidad.PeliculaActor", b =>
                {
            ...
            modelBuilder.Entity("GeneroPelicula", b =>
                {
                    b.HasOne("IntroduccionAEFCore1.Entidad.Genero", null)
                        .WithMany()
                        .HasForeignKey("GenerosId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("IntroduccionAEFCore1.Entidad.Pelicula", null)
                        .WithMany()
            ...
            modelBuilder.Entity("IntroduccionAEFCore1.Entidad.Comentario", b =>
                {
                    b.HasOne("IntroduccionAEFCore1.Entidad.Pelicula", "Pelicula")
            ...
            modelBuilder.Entity("IntroduccionAEFCore1.Entidad.PeliculaActor", b =>
                {
                    b.HasOne("IntroduccionAEFCore1.Entidad.Actor", "Actor")
